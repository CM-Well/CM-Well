...
trait FTSServiceOps {
  ...
  def get(uuid: String, indexName: String, partition: String = defaultPartition)(
    implicit executionContext: ExecutionContext): Future[Option[(FTSThinInfoton,Boolean)]]
  ...
  def aggregate(pathFilter: Option[PathFilter],
                ...
                partition: String = defaultPartition,
                debugInfo: Boolean = false)(implicit executionContext: ExecutionContext): Future[AggregationsResponse]
