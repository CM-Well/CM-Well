    ...
    cmwell.app = angular.module('cmwellAngApp', [
        ...
        .filter('rdfValueToHtml', function ($sce) {
            return function (rdfValue) {
                ...
                , markup = rdfValue.value +
                    (q ? '<span class="quad" data-quad="'+q+'" title="'+q+'"><img width="18px" src="/meta/app/images/graph.svg"/></span>' : '');
        ...
        .directive('cmwellPager', function () {
            return {
                ...
                templateUrl: '/meta/app/views/pager.html?override-mimetype=text/html'
            };
        })
        ...
        .directive('cmwellNaviFields', function () {
            return {
                scope: false, // use outer $scope
                templateUrl: '/meta/app/views/fields-navi.html?override-mimetype=text/html'
            };
        })
