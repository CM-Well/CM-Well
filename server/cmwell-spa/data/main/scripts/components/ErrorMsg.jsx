    ...
    render() {
        return <div className="error-msg-container">
            <div className="error-sign-container">
                <img id="error-sign" src="/meta/app/main/images/recoverable-error-sign.svg" />
                <div className="error-sign-text">Error occurred</div>
                <img id="cone1" src="/meta/app/main/images/cone-1.svg" />
                <img id="cone2" src="/meta/app/main/images/cone-2.svg" />
            </div>
