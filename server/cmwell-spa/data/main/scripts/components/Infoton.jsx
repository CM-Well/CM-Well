...
class FavStar extends React.Component {
    ...
    render() {
        ...
        return <img className={className} src="/meta/app/main/images/fav-star.svg" onClick={this.handleClick.bind(this)} />
    }
}
...
class FileInfoton extends React.Component {
    render() {
        ...
        return <div className="file-infoton-content">
            <a href={downloadUrl} download={AppUtils.lastPartOfUrl(sysFields.path)}><img src="/meta/app/main/images/download.svg"/>Download</a><br/>
...
class Infoton extends React.Component {
    ...
    render() {
        ...
        let iconSrc = `/meta/app/main/images/${this.state.infoton && this.state.infoton.type === 'FileInfoton' ? 'file' : 'infoton'}-icon.svg`
        ...
        return _.isEmpty(dataFields) && !fileContents ? (this.state.infoton && this.state.infoton.system ? <SystemFields data={this.state.infoton.system} hasNoDataFields={true} /> : null) : (<div>
            <div className="infoton-title">
                ...
                <img src="/meta/app/main/images/alerts-icon.svg" className="alerts-icon" title="Get alerts" />
            </div>
