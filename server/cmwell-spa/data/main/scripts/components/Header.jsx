...
class Breadcrumbs extends React.Component {
    ...
    render() {
        ...
        let sep = <img src='/meta/app/main/images/gt.svg' width="24" height="24" />
        let rootLevelIcon = <img src='/meta/app/main/images/folder-box.svg' width="24" height="24" />
        let otherLevelsIcon = <img src='/meta/app/main/images/infoton-icon.svg' width="24" height="24" />
        let searchIcon = <img className="search-icon" src='/meta/app/main/images/search-icon.svg' width="24" height="24" />
            
        return <div className="breadcrumbs">
                    <Link className="breadcrumb" to="/"><img width="24" height="24" src="/meta/app/main/images/home-button.svg"/></Link>
