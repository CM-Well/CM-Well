...
fullTest := (test in IntegrationTest).dependsOn(fullTest in LocalProject("bg"),fullTest in LocalProject("irw"),fullTest in LocalProject("fts"),fullTest in LocalProject("zstore")).value