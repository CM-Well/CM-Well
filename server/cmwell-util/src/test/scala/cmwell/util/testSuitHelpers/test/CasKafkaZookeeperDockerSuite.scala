...
trait CasKafkaZookeeperDockerSuite extends ForAllTestContainer { this:Suite =>
  ...
  override val container = MultipleContainersParallelExecution(cassandraContainer, kafkaZooCombined)
}
