...
class BinRangeSearchTests
  ...
  describe("binRangeSearch should") {
    ...
    val earlyCutOffWithTimeToShrink: (Future[Assertion], Future[Assertion]) = {
      ...
      val f0 =
        expandRange[Long](83929378534L, 1425817765688L, 1508943374048L, 500000, 1500000, timeout.future)(searchFunction)
    ...
    val earlyCutOffWhileExpanding: Future[Assertion] = {
      ...
      expandRange[Long](83929378534L, 1425817765688L, 1508943374048L, 500000, 1500000, timeout)(searchFunction).map {
        either =>
