...
dependenciesManager in Global := {
  ...
  case ("com.dimafeng","testcontainers-scala")                     => "com.dimafeng" %% "testcontainers-scala" % "0.23.0"
  ...
  case ("com.github.tomakehurst", "wiremock")                      => "com.github.tomakehurst" % "wiremock" % "2.21.0"
  ...
  case ("com.typesafe.play", "play-json")                          => "com.typesafe.play" %% "play-json" % "2.7.1"
...
//  case ("io.netty", "netty-transport")                             => "io.netty" % "netty-transport" % "4.1.17.Final"
  ...
  case ("net.logstash.logback", "logstash-logback-encoder")        => "net.logstash.logback" % "logstash-logback-encoder" % "5.3"
  case ("net.sf.ehcache","ehcache")                                => "net.sf.ehcache" % "ehcache" % "2.10.2"
  case ("nl.grons", art)                                           => "nl.grons" %% art % "4.0.4" // make sure to update also "io.dropwizard.metrics" dependencies
  ...
  case ("org.apache.httpcomponents","httpclient")                  => "org.apache.httpcomponents" % "httpclient" % "4.5.7"
  ...
  case ("org.joda","joda-convert")                                 => "org.joda" % "joda-convert" % "2.2.0"
