...
//  case ("io.netty", "netty-transport")                             => "io.netty" % "netty-transport" % "4.1.17.Final"
  ...
  case ("org.lz4","lz4-java")                                      => "org.lz4" % "lz4-java" % "1.5.1"
  ...
  case ("org.rogach","scallop")                                    => "org.rogach" %% "scallop" % "3.2.0"
  ...
  case ("org.scalatest","scalatest")                               => "org.scalatest" %% "scalatest" % "3.0.6"
