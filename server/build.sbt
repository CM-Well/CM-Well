...
dependenciesManager in Global := {
  ...
  case ("com.github.tomakehurst", "wiremock")                      => "com.github.tomakehurst" % "wiremock" % "2.20.0"
  ...
  case ("com.lightbend.akka", "akka-stream-alpakka-cassandra")     => "com.lightbend.akka" %% "akka-stream-alpakka-cassandra" % "0.20"
  ...
  case ("com.typesafe.akka", "akka-stream-kafka")                  => "com.typesafe.akka" %% "akka-stream-kafka" % "1.0-RC1"
  ...
  case ("com.typesafe.akka",art)                                   => "com.typesafe.akka" %% art % "2.5.19"
  case ("com.typesafe.play", "twirl-api")                          => "com.typesafe.play" %% "twirl-api" % "1.3.13"
  case ("com.typesafe.play", "play-json")                          => "com.typesafe.play" %% "play-json" % "2.6.13"
  ...
  case ("io.netty", "netty-transport")                             => "io.netty" % "netty-transport" % "4.1.32.Final"
  case ("io.circe", art)                                           => "io.circe" %% art % "0.11.0"
  case ("io.dropwizard.metrics",art)                               => "io.dropwizard.metrics" % art % "4.0.3" // make sure this is a compatible version with "nl.grons" metrics dependencies!
  ...
  case ("org.lz4","lz4-java")                                      => "org.lz4" % "lz4-java" % "1.5.0"
  case ("net.lingala.zip4j", "zip4j")                              => "net.lingala.zip4j" % "zip4j" % "1.3.2"
  ...
  case ("nl.grons", art)                                           => "nl.grons" %% art % "4.0.3" // make sure to update also "io.dropwizard.metrics" dependencies
  ...
  case ("org.apache.lucene",art)                                   => "org.apache.lucene" % art % "7.6.0"
  case ("org.apache.commons","commons-compress")                   => "org.apache.commons" % "commons-compress" % "1.18"
  case ("org.apache.commons", "commons-lang3")                     => "org.apache.commons" % "commons-lang3" % "3.8.1"
  ...
  case ("org.codehaus.plexus","plexus-archiver")                   => "org.codehaus.plexus" % "plexus-archiver" % "4.0.0"
  case ("org.codehaus.plexus","plexus-container-default")          => "org.codehaus.plexus" % "plexus-container-default" % "1.7.1" //"1.6"
  case ("org.codehaus.plexus","plexus-utils")                      => "org.codehaus.plexus" % "plexus-utils" % "3.1.1"
  ...
  case ("org.hdrhistogram","HdrHistogram")                         => "org.hdrhistogram" % "HdrHistogram" % "2.1.10"
  case ("org.jfarcand","wcs")                                      => "org.jfarcand" % "wcs" % "1.3"
  case ("org.jdom","jdom2")                                        => "org.jdom" % "jdom2" % "2.0.6"
  case ("org.joda","joda-convert")                                 => "org.joda" % "joda-convert" % "2.1.2"
  ...
  case ("org.rogach","scallop")                                    => "org.rogach" %% "scallop" % "3.1.5"
  ...
  case ("org.scala-lang.modules", "scala-xml")                     => "org.scala-lang.modules" %% "scala-xml" % "1.1.1"
