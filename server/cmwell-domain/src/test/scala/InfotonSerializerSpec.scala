...
class InfotonSerializerSpec extends FlatSpec with Matchers {
  ...
  "very big infoton" should "be successful" in {
    ...
    val objInfo = new ObjectInfoton(
      ...
      dc = "test",
      fields =
        Option(Map[String, Set[FieldValue]]("g" -> Set(FString("h")), "last" -> Set(FString("zitnik")), "name" -> x))
    )
  ...
  "empty file infoton serializer" should "be successful" in {
    ...
    val emptyInfo = FileInfoton("/command-test/objinfo1",
                                "dc_test",
                                None,
                                Map("name" -> Set[FieldValue](FString("gal"), FString("yoav"))),
                                fc)
  ...
  "file binary infoton serializer" should "be successful" in {
    ...
    val imgInfo = FileInfoton("/command-test/objinfo1",
                              "dc_test",
                              None,
                              Map("name" -> Set[FieldValue](FString("gal"), FString("yoav"))),
                              img)
  ...
  "file text infoton serializer" should "be successful" in {
    ...
    val textInfo = FileInfoton("/command-test/objinfo1",
                               "dc_test",
                               None,
                               Map("name" -> Set[FieldValue](FString("gal"), FString("yoav"))),
                               text)
  ...
  "big file infoton with % chunkSize != 0" should "be successful" in {
    ...
    val fInf = FileInfoton("/command-test/fileinfo1",
                           "dc_test",
                           None,
                           Map("name" -> Set[FieldValue](FString("gal"), FString("yoav"))),
                           data)
  ...
  "link infoton serializer" should "be successful" in {
    val forward = LinkInfoton("/command-test/objinfo1",
                              "dc_test",
                              Map("name" -> Set[FieldValue](FString("gal"), FString("yoav"))),
                              "/mark",
                              LinkType.Forward)
    ...
    val per = LinkInfoton("/command-test/objinfo1",
                          "dc_test",
                          Map("name" -> Set[FieldValue](FString("gal"), FString("yoav"))),
                          "/mark",
                          LinkType.Permanent)
    ...
    val temp = LinkInfoton("/command-test/objinfo1",
                           "dc_test",
                           Map("name" -> Set[FieldValue](FString("gal"), FString("yoav"))),
                           "/mark",
                           LinkType.Temporary)
