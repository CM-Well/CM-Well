...
case class ElasticsearchNodeBadCodeEvent(id: String, code: Int)
    extends CassandraEvent
...
case class DcLostConnectionEvent(id: String, checkerHost: String)
    extends DcEvent
case class DcCouldNotGetDcEvent(id: String, checkerHost: String) extends DcEvent
case class DcCouldNotGetDcLongEvent(id: String, checkerHost: String)
    extends DcEvent
...
case class ComponentChangedColorEvent(id: String, color: StatusColor)
