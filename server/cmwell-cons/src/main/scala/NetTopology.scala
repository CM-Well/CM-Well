...
abstract class NetTopology(amountPerMachine: Int = 4,
                           cidr: Int = 16,
...
case class FixedTopology(amountPerMachine: Int, cidr: Int)
    extends NetTopology(amountPerMachine, cidr)
case class VLanTopology(tag: Int, amountPerMachine: Int = 4, cidr: Int = 16)
    extends NetTopology(amountPerMachine, cidr)
