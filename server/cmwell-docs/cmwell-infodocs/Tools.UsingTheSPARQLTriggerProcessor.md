...
3. Perform a Git clone of the CM-Well Data Tools source code from [https://git.sami.int.thomsonreuters.com/cm-well/cmwell-data-tools](https://git.sami.int.thomsonreuters.com/cm-well/cmwell-data-tools).
