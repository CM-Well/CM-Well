...
* [Overview of the CM-Well API](Introduction/Intro.OverviewOfTheCM-WellAPI.md)
...
* [CM-Well Developer Guide](DeveloperGuide/DevGuide.GettingStarted.md)
...
!!! note
	You may need to give sbt more heap to compile. A 2GB heap works, which you can set by specifiying the following:
