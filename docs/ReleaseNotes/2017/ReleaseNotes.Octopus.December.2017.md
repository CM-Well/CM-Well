...
Changes to SPARQL Trigger Processor configuration | N/A | Use X-CM-WELL-TOKEN header for authentication; configuration file path changed; start/stop flag no longer created automatically. See [Using the SPARQL Trigger Processor](../../AdvancedTopics/Tools/Tools.UsingTheSPARQLTriggerProcessor.md) for more details.
...
Changes to SPARQL Trigger Processor configuration. See [Using the SPARQL Trigger Processor](../../AdvancedTopics/Tools/Tools.UsingTheSPARQLTriggerProcessor.md) for more details.
