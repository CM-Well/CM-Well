...
**Documentation:** [Using the with-deleted Flag](../../APIReference/UsageTopics/API.UsingTheWith-deletedFlag.md)
...
You can apply SPARQL queries to specific paths within the CM-Well graph, using the `_sp` endpoint (see [Apply SPARQL to Query Results](../../APIReference/Query/API.Query.ApplySPARQLToQueryResults.md)).
...
**Documentation:** [Apply SPARQL to Entire Graph](../../APIReference/Query/API.Query.ApplySPARQLToEntireGraph.md)
...
**Documentation:** [Calling Custom Java/Scala Functions from SPARQL Queries](../../DeveloperGuide/DevGuide.CallingJavaScalaFunctionsFromSPARQLQueries.md)
...
**Documentation:** [SPARQL: Uploading CONSTRUCTs as Stored Procedures](../../DeveloperGuide/DevGuide.UsingSPARQLOnCM-WellInfotons.md#hdr).
...
* [Developer Guide: Using Elastic Search Statistics](../../DeveloperGuide/DevGuide.UsingElasticSearchStatistics.md) 
* [API Reference: Data Statistics](../../APIReference/Query/API.Query.DataStatistics.md)
...
**Documentation:** [Sorting Results with the sort-by Flag](../../APIReference/UsageTopics/API.SortingResultsWithTheSort-byFlag.md)
