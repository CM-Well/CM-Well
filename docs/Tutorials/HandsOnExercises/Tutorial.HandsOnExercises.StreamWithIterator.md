...
```	
	{"type":"IterationResults","iteratorId":"YWtrYS50Y3A6Ly9jbS13ZWxsLXByb2RAMTAuMjA0LjE3Ny4xOjQ4ODMxL3VzZXIvJGJkYiMtMTc4MTcxOTQwMA",
	"totalHits":94271748,"infotons":[]}
```
...
[Create Iterator](../../APIReference/Stream/API.Stream.CreateIterator.md)

[Get Next Chunk](../../APIReference/Stream/API.Stream.GetNextChunk.md)
