...
First, learn about [CM-Well Docker and how to install and run it](../AdvancedTopics/Tools/Tools.UsingCM-WellDocker.md). 
...
!!! note
	If you're planning to use the Curl command, read [Using the Curl Utility to Call CM-Well](../DeveloperGuide/DevGuide.CurlUtility.md).
...
[Query for Infotons Using Field Conditions](../APIReference/Query/API.Query.QueryForInfotonsUsingFieldConditions.md)
